...
const Notecard = ({note}) => {
  ...
  return (
    <div className="bg-white dark:bg-cyan-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-md hover:shadow-lg transition-all p-5 flex flex-col">
      {isEditing ? (
        <>
          {/* Edit Mode */}
          <input
            ...
            className="border rounded-lg p-2 w-full mb-3 
                       focus:ring-2 focus:ring--500 outline-none 
